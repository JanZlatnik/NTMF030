...
name = '2.wavefunction_1'
aspect_ratio = 'square'
filenames = [r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 2\Eigenfunctions\eigenfunctions_l=1.txt"]
x_column = 1
y_columns = [2]
show_legend = True  
legend_title = r"$l=1$"  
...
legends = [[r"$E \approx -2.96\,\mathrm{Ha} $"],[0],[0],[0]]
labels = [[0,0,0,0]]
