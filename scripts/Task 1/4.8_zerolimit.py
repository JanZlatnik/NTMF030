...
name = '4.8_zerolimit'
aspect_ratio = 'square'
filenames = [r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 4.8\zero_energy_limit.txt"]
x_column = 1
y_columns = [2]
show_legend = True  
legend_title = r"$\alpha=4.8$"  
legend_frame = False 
...
legends = [[r"$l=0$",r"$l=1$",r"$l=2$",r"$l=3$"],[0],[0],[0]]
labels = [[0,0,0,0]]
...
if show_legend:
    if legend_title != 0:
        ax.legend(frameon=legend_frame, title=legend_title, loc = "lower left")
    else:
