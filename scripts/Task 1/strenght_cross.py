...
name = 'strenght_cross_0'
aspect_ratio = 'square'
filenames = [r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 1\cross_sections.txt",
             r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 4.7\cross_sections.txt",
             r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 4.8\cross_sections.txt",
             r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 4.9\cross_sections.txt",
             r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 10\cross_sections.txt"]
x_column = 1
y_columns = [2]
show_legend = True  
legend_title = r"$l=0$"  
