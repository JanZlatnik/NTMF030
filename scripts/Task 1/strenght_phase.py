...
name = 'strenght_phase_3'
aspect_ratio = 'square'
filenames = [r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 1\phase_shifts.txt",
             r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 4.7\phase_shifts.txt",
             r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 4.8\phase_shifts.txt",
             r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 4.9\phase_shifts.txt",
             r"D:\Univerzita\Quantum scattering theory\Potential_scattering\Task 1\alpha = 10\phase_shifts.txt"]
x_column = 1
y_columns = [5]
show_legend = True  
legend_title = r"$l=3$"  
...
Y_axis = r'Phase shift'
legends = [[r"$1.0$"],[r"$4.7$"],[r"$4.8$"],[r"$4.9$"],[r"$10$"]]
labels = [[0],[0],[0],[0],[0]]
labels_position = [[0],[0],[0],[0],[0]]  
...
if show_legend:
    if legend_title != 0:
        ax.legend(frameon=legend_frame, title=legend_title, loc = "lower right")
    else:
